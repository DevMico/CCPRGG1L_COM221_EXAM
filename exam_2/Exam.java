...
public class Exam {
    ...
    public static void main(String[] args) throws Exception {
        ...
        else if (lastDigit % 2 == 0 || lastDigit % 3 == 0 || lastDigit % 5 == 0 || lastDigit % 7 == 0 && lastDigit != 2 && lastDigit != 3 && lastDigit != 5 && lastDigit != 7){
        ...
        int stunsum = studentNumber - 2021000000;
        System.out.println(stunsum);
        ...
        System.out.print("Enter your ten digit student number: ");
        int myStudentNumber = 2021300032;
        int stuNum = scan.nextInt();
        if (stuNum == myStudentNumber){
        ...
        String surN = "salandanan";
        
        if (studentEmailAddress.contains(surN) && studentEmailAddress.contains("@students.national-u.edu.ph"))
        System.out.println("Valid");
        else {
            System.out.println("Invalid");
        }
